...
namespace EasyNow.Dal
{
    ...
    public partial class UserConfiguration : IEntityTypeConfiguration<User>
    {
        ...
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.Property<string>(x => x.Account).HasColumnName(@"Account").IsRequired().ValueGeneratedNever().HasMaxLength(200);
            builder.Property<string>(x => x.Password).HasColumnName(@"Password").IsRequired().ValueGeneratedNever().HasMaxLength(200);
